 ...
 */
class Dashboard extends \FacturaScripts\Core\Base\Controller
{
    ...
    public function getPageData()
    {
        ...
        $pageData['title'] = 'dashboardPlugin';
        $pageData['menu'] = 'debug';
    ...
    private function getListComponents($userNick)
    {
        ...
        foreach ($rows as $data) {
            $componentName = \FacturaScripts\Plugins\Dashboard\Lib\BaseComponent::DIR_COMPONENTS
                . $data->component
                . \FacturaScripts\Plugins\Dashboard\Lib\BaseComponent::SUFIX_COMPONENTS;
